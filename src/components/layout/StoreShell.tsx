    ...
    return (
        <div className="flex flex-col min-h-screen bg-bgBody">
            ...
            <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white/90 backdrop-blur-md sticky top-0 z-40 border-b border-gray-100">
                <span className="font-extrabold text-lg text-primary tracking-tight">Car Life</span>
                <div className="flex items-center gap-3">
                    <CurrencySelector />
                    <button
                        onClick={() => setIsCustomModalOpen(true)}
                        className="w-8 h-8 rounded-full bg-black text-white flex items-center justify-center shadow-md active:scale-90 transition-transform"
